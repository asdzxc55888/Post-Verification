...
class Config:
    ...
    num_class = 17
    keypoint_result_path = os.path.join('results')
    output_video_path = os.path.join('outputs')
    video_path = os.path.join('data', 'medias')
    video_info_path = os.path.join('data', 'video_info')
    img_path = os.path.join(root_dir, 'data', 'images')
    img_info_path = os.path.join(root_dir, 'data', 'images_info.json')
